...
class Blockchain:
    ...
    def add_transaction(self, pharmacist, medical_retailer, list):
...
def add_transaction():
    ...
    transaction_keys = ['pharmacist', 'medical_retailer', 'list']
    if not all(key in json for key in transaction_keys):
        return 'Some elements of the transaction are missing', 400
    index = blockchain.add_transaction(json['pharmacist'], json['medical_retailer'], json['list'])
